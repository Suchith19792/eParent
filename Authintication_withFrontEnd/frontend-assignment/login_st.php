...
if (isset($_POST['user_name'])) {
  ...
  $MM_redirectLoginSuccess = "welcome_page.php";
  $MM_redirectLoginFailed = "login_student.php?a=1";
  ...
  <div class="field-wrapper contained h-short">
    ...
    <hr>
      ...
      <form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
        <div class="question left right-align">
          User Name
        </div>
        <div class="answer right short">
      ...
      <span class="textfieldRequiredMsg">Feild is required.</span></span>
        ...
        <input name="login" type="submit" class="sbmt" id="login" value="Submit" />
