...
if (isset($_POST['inst_name'])) 
{
  ...
  $LoginRS__query=sprintf("SELECT login, password FROM institutions WHERE login=%s AND password=%s",
    ...
    <hr>
      ...
      <table width="300" align="center"><tr>
        ...
        <td class="answer right short">
          <label for="inst_name"></label>
        <span id="sprytextfield1">
        <input type="text" name="inst_name" id="inst_name" placeholder="Value"/>
      ...
      <span class="textfieldRequiredMsg">Feild is required.</span></span>
        ...
        <tr><td class="question left right-align">&nbsp;</td><td class="answer right short"><input type="submit" name="login" id="login" value="Submit" class="sbmt"/></td></tr></table>
        </form>
      </div>
    </div>
  </div>
